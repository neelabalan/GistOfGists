...
def get_url(key: str, user: str=None, page: int=1, total: int=None) -> Optional[str]:
    ''' 
...
def fetch_responses(total_gist: int, user_urls: Callable[..., Any]) -> List[Dict[Any, Any]]:
...
def construct_table(gists: List[Dict[Any, Any]], writer: MarkdownTableWriter) -> MarkdownTableWriter:
